...
<body
                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="content-cell"
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            ...
                                                                            <span
                                                                                ...
                                                                                onclick="copyToClipboard('{{ $code }}')">{{ $code }}</span>

                                                                            <span id="copyMessage"
                                                                                style="display: none; color: green;">Copied!</span>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                        ...
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            This email verification code will expire in 60 minutes.</p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
    ...
    <script>
        function copyToClipboard(text) {
            ...
            document.getElementById('copyMessage').style.display = 'inline'; // Display the copy message
            setTimeout(function() {
                document.getElementById('copyMessage').style.display =
                    'none'; // Hide the copy message after 3 seconds
            }, 2000);
        }
    </script>
</body>
