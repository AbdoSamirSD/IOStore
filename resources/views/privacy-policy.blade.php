...
<body>
    ...
    <p>This privacy policy applies to the {{ config('app.name') }} app (hereby referred to as "Application") for mobile
        devices that
        was created as a Free service. This service is intended for use
        "AS IS".</p><br><strong>Information Collection and Use</strong>
    ...
    <p>For a better experience, while using the Application, the Service Provider may require you to provide us with
        certain personally identifiable information, including but not limited to chemistryapp1@gmail.com. The
    ...
    <p>The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable
        ...
        please contact them at chemistryapp1@gmail.com and they will respond in a reasonable time.</p>
    ...
    <div><br>
        <p>The Application does not address anyone under the age of 13.
            ...
            personal information, please contact the Service Provider (chemistryapp1@gmail.com) so that
    ...
    <p>This privacy policy is effective as of 2024-10-26</p><br><strong>Your Consent</strong>
    ...
    <p>If you have any questions regarding privacy while using the Application, or have questions about the practices,
        please contact the Service Provider via email at chemistryapp1@gmail.com.</p>
    <hr>
